...
async def cmd_start(
    ...
    if not consent_given and not is_pharmacist:
        ...
        privacy_text = (
            ...
            "Я помогу вам найти лекарства и получить консультацию фармацевтического работника.\n\n"
            "🔒 <b>Защита данных (Закон РБ №99-З и GDPR)</b>\n"
            "Для работы бота необходимо ваше согласие на обработку персональных данных.\n\n"
            "📋 <b>Что и зачем мы обрабатываем:</b>\n"
            "• Telegram ID, имя и фамилия (для работы бота)\n"
            "• Номер телефона (только при вашем согласии)\n"
            "• Тексты вопросов и история консультаций (для ответов фармацевта)\n\n"
            "🌍 <b>Трансграничная передача:</b>\n"
            "Серверы Telegram находятся вне РБ (ОАЭ, ЕС). Из-за этого ваши данные передаются за рубеж.\n"
            "⚠️ <b>Риски:</b> в этих странах может отсутствовать адекватный уровень защиты прав субъектов данных, а механизмы защиты законодательства РБ там не действуют.\n\n"
            "✅ <b>Меры безопасности и сроки:</b>\n"
            "• Шифрование ID и телефона в БД (AES-256, класс ИС 3-ин по требованиям ОАЦ)\n"
            "• Хранение данных: 1 год с момента последнего обращения\n\n"
            "🔄 <b>Альтернативные каналы (без Telegram):</b>\n"
            "• Сайт: <a href='https://spravka.novamedika.com'>spravka.novamedika.com</a> (серверы в РБ)\n"
            "• Email: support@novamedika.com\n\n"
            "📖 Подробно: <a href='https://spravka.novamedika.com/privacy-policy'>Политика конфиденциальности</a>\n\n"
            "Нажимая <b>«✅ Согласен»</b>, вы подтверждаете, что ознакомлены с Политикой конфиденциальности, добровольно даете согласие на обработку данных и понимаете риски их трансграничной передачи."
        )
