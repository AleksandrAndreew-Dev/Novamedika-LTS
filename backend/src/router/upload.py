...
async def upload_file(pharmacy_name: str, pharmacy_number: str, file: UploadFile = File(...)):
    try:
        ...
        if content is None:
            logger.warning("Could not decode file with any encoding, using utf-8 with error replacement")
