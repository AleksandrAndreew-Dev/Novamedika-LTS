...
Эта папка содержит всю документацию, необходимую для соответствия требованиям Оператора Активных Компонентов (ОАЦ) Республики Беларусь и Закона №99-З «О защите персональных данных».
