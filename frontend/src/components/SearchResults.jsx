    ...
    <div className={`${isTelegram ? "p-2" : "p-4"} max-w-6xl mx-auto`}>
      <div className="bg-white rounded-2xl shadow-sm border border-telegram-border overflow-hidden">
        ...
        <div className="p-4 md:p-6">
          ...
          {isTelegram ? (
            <div className="space-y-3" role="list" aria-label="Результаты поиска лекарств">
                ...
                >
                  ...
                  <div className="text-sm text-gray-800 space-y-2">
                    <div className="flex items-start">
                      ...
                      <span>{item.pharmacy_name} №{item.pharmacy_number}, {item.pharmacy_address}</span>
                    </div>
            ...
            <div className="space-y-4" role="list" aria-label="Результаты поиска лекарств">
              {groupedResults.map((item, index) => (
                <div
                  key={index}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm md:text-base">
                    <div>
                      <div className="flex items-center text-gray-800 mb-2">
                        ...
                        <div>
                          <strong className="text-gray-900">{item.pharmacy_name}</strong> №{item.pharmacy_number}
                        </div>
                      </div>
                      <div className="text-gray-800 ml-7">{item.pharmacy_address}, {item.pharmacy_city}</div>
                    </div>
                    ...
                    <div>
                      <div className="flex items-center text-gray-800 mb-2">
                        ...
                        <span className="text-gray-900 font-medium">Телефон:</span> {item.pharmacy_phone}
                      </div>
          ...
          {groupedResults.length === 0 && !loading && (
            <div className="text-center py-12" role="status">
              ...
              <p className="text-gray-800 text-sm mb-6">
                Попробуйте изменить параметры поиска или выбрать другую форму препарата
              </p>
