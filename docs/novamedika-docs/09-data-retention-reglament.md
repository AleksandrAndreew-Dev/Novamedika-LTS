...
**Дата обновления:** 08.06.2026 г. (добавлено распределение ответственности с хостинг-провайдером, ссылки на HOSTER-DIVISION-OF-WORK.md)
...
### 5.1. Распределение ответственности с хостинг-провайдером

Согласно [planning/HOSTER-DIVISION-OF-WORK.md](../planning/HOSTER-DIVISION-OF-WORK.md), часть задач по хранению и backup передана хостинг-провайдеру:

| Категория ПД | Ответственный за хранение | Ответственный за удаление |
|-------------|------------------------|------------------------|
| PostgreSQL (qa_users, qa_pharmacists, booking_orders) | 🟢 [МЫ] (наш контейнер) + 🔵 [ХОСТЕР] (инфраструктура) | 🟢 [МЫ] (Celery) + 🔵 [ХОСТЕР] (backup retention) |
| Backup PostgreSQL (ежедневно) | 🔵 [ХОСТЕР] (S3 / backup storage, retention 365 дней) | 🔵 [ХОСТЕР] (после 365 дней) |
| Логи Docker (json-file) | 🟢 [МЫ] (контейнеры) + 🔵 [ХОСТЕР] (инфраструктура) | 🟡 [СОВМЕСТНО]: ротация 10m×3 (наша), архивирование 395 дней (хостер) |
| Audit logs (audit_logs) | 🟢 [МЫ] (PostgreSQL) | 🟢 [МЫ] (Celery) |

**Примечание:** Хостинг-провайдер является уполномоченным лицом (ст. 7 Закона №99-З). Соглашение об обработке ПД — в процессе заключения.

### 5.3. Celery beat расписание
...
*Связанные документы: [04-privacy-policy.md](04-privacy-policy.md), [HOSTER-DIVISION-OF-WORK.md](../planning/HOSTER-DIVISION-OF-WORK.md), [audit-personal-data-2026-06-08.md](../privacy-policy/audit-personal-data-2026-06-08.md).*
